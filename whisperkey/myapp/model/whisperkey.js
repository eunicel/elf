...
// create user
whisperkeySchema.statics.createWhisperkey = function(data, callback){
	var whisperkey = new Whisperkey(data);
	whisperkey.save(function(err){
		if(err){
...
*/
var Whisperkey = mongoose.model('Whisperkey', whisperkeySchema);

module.exports = Whisperkey;
